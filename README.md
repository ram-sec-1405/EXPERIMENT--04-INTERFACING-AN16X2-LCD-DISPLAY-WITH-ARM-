...
{
  Lcd_cursor(&lcd, 0, 1);
  Lcd_string(&lcd, "Austin");

  Lcd_cursor(&lcd, 1, 1);
  Lcd_string(&lcd, "212224040038");
}
/* USER CODE END 4 */
...
<img width="1108" height="772" alt="Screenshot 2025-09-17 093316" src="https://github.com/user-attachments/assets/be0f2335-d8e3-4a00-99cd-31420a89a2c4" />

 
 
 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 <img width="969" height="684" alt="lcd2" src="https://github.com/user-attachments/assets/3c0efd85-d9f5-45e9-80d4-0022ad041d46" />
